...
def main():
    ...
    # to modify the specific openfe arguments, update the config in rampds/feat_eng/config/openfe.yaml
    args = parser.parse_args()

    kaggle_ramp_kit = f"kaggle_{args.ramp_kit}"
    setup_root = RAMP_SETUP_KITS_NAS_PATH
    kit_root = "openfe_new_setup/"
    
    # Use the original setup function with openfe option
    rs.setup(
        ramp_kit=kaggle_ramp_kit,
